...
public class Advanced extends Machine{
	...
	/**
	 * Constructor for the Advanced machine class.
	 *
	 ...
	 */
	public Advanced(String name,String color, HashMap<String, Integer> limitWalls, int[] location)	{
	...
	/**
	 * Generete the new position of barrier.
	 * 
	 * @param pos
	 * @param board
	 * @return
