...
public class Ally extends Wall{
	 ...
	 * @param orientation
	 */
	public Ally(int number, String player, int[] location, char orientation)	{
		
		super(number,player, location, orientation);
		this.identification = orientation+String.valueOf(number)+"Ally"+"."+player;
	}
